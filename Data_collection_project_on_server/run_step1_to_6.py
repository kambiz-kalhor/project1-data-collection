...
#first_input_path = r'Data_collection_project/MAIN_INPUT.csv'
first_input_path = r'Data_collection_project/TEST_INPUT.csv'

# and again please give me the output path to save the final result
#step_one_to_six_output_path = r'Data_collection_project/step_one_to_six_output_MAIN.csv'
step_one_to_six_output_path = r'Data_collection_project/step_one_to_six_output_test.csv'
...
bacDive = pd.read_csv(first_input_path)
...
######################################################
# save the output
all_data_together.to_csv(step_one_to_six_output_path)


print('first six steps are done :) :)  :) .................')
